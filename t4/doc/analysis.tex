...
model used by Ngspice is way more complex than the one implemented theoretically.\par
...
\par
\begin{figure}[H] \centering
\includegraphics[width=0.6\linewidth]{gain_octave.eps}
