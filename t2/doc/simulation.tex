...
In \textbf{Figure: ~\ref{fig:Magnitude}} the \textit{x axis} represents the frequency using a logarithmic scale and the \textit{y axis} the magnitude in dB.  
\begin{figure}[h] \centering
\includegraphics[width=0.6\linewidth]{acm.pdf}
\caption{Magnitude of $V_s(f)$, $V_c(f)$  and of $V_6(f)$ }
\label{fig:Magnitude}
\end{figure}
\pagebreak
\par
In \textbf{Figure: ~\ref{fig:phase}} the \textit{x axis} represents the frequency using a logarithmic scale and the \textit{y axis} the phase in degrees.  
\begin{figure}[h] \centering
\includegraphics[width=0.6\linewidth]{phase.pdf}
\caption{Phase of $V_s(f)$, $V_c(f)$ and of $V_6(f)$}
\label{fig:phase}
\end{figure}
